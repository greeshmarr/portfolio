...
export const ExperiencePage = ({
  ...
  const experiences = [
    ...
    },
    {
      ...
      location: "Bengaluru",
      description:
        "Worked on Identity and Access Management (IAM) solution, building secure REST APIs for credential management and user provisioning using Java and Spring Boot.",
      achievements: [
  ...
  return (
    <>
      ...
      <motion.div
        ...
        exit={{ opacity: 0, y: -20 }}
        className="min-h-screen bg-white pt-24 px-8 relative"
      >
        <div className="max-w-4xl mx-auto relative z-10">
          <motion.h1
            ...
            className="text-4xl font-bold mb-12 mt-4 text-center md:text-6xl text-gray-900"
          >
